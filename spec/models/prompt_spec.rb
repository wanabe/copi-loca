...
RSpec.describe Prompt, type: :model do
  ...
  describe '.find_by' do
    it 'loads prompt by id' do
      ...
      expect(Prompt).to have_received(:new).with(id: 1)
  ...
  describe '.all' do
    it 'returns all prompts' do
      ...
      expect(Prompt).to have_received(:new).with(id: 1).once
      expect(Prompt).not_to have_received(:new).with(id: 'ignore')
